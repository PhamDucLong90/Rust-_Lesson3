...
fn exercise5() {
    ...
    let moved_field_1 = &foos[0].str_val;
    println!("gia tri cua moved_field_1 la {}" , moved_field_1);

    let moved_field_2 = &foos[0].int_val;
    println!("gia tri cua moved_field_2 la {}" , moved_field_2);

    let moved1_field_1 = &foos[1].str_val ;
    println!("gia tri cua moved1_field_1 la {}" , moved1_field_1); 

    let moved1_field_2 = &foos[1].int_val ; 
    println!("gia tri cua moved1_field_2 la {}" , moved1_field_2);
